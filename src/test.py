...
async def gpio_poll_task(page: ft.Page, state: AppState):
    ...
    Updates Lower container info labels accordingly.
    """
...
def build_no_cell(state: AppState, no_index: int) -> ft.Container:
    ...
    img_onoff = ft.Image(src_base64=state.b64_light_off, width=180, height=180)
    ...
    battery_stack = ft.Stack(
        ...
        height=180,
        controls=[
            ft.Image(src_base64=state.b64_battery, width=180, height=180),
            ft.Container(
                content=temp_text,
                width=180,
                height=180,
